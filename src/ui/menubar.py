        ...
        try:
            with h5py.File(full_file_name,'r') as ins_top_results_file:
                ...
                if len(instance_include_geometry_list) == 1 and 'surface' in instance_include_geometry_list:
                    ...
                    if smooth_filter == 'On':
                        ins_surface_ugrid = vtk.vtkUnstructuredGrid()
                        ins_surface_ugrid.SetPoints(ins_whole_points)
                        ins_surface_result_array = vtk.vtkDoubleArray()
                        ins_surface_result_array.SetName('EX')
                        ins_solid_ugrid = vtk.vtkUnstructuredGrid()
                        ins_solid_ugrid.SetPoints(ins_whole_points)
                        ins_solid_result_array = vtk.vtkDoubleArray()
                        ins_solid_result_array.SetName('EX')
                        for element_label in range(instance_elements_label_range[0],instance_elements_label_range[1]+1):
                            element_geometry_type_number = ins_assembly_include_elements_geometry_set[element_label-1]
                            element_include_nodes_label = ins_assembly_include_elements_set[element_label-1]
    
                            if element_geometry_type_number in trans_vtk_surface_geometry_dict:
                                ins_surface_ugrid.InsertNextCell(trans_vtk_surface_geometry_dict[element_geometry_type_number],len(element_include_nodes_label),element_include_nodes_label-1)
                                ins_surface_result_array.InsertNextValue(ins_output_frame_result_set[0,element_label-1])
                            elif element_geometry_type_number in trans_vtk_solid_geometry_dict:
                                ins_solid_ugrid.InsertNextCell(trans_vtk_solid_geometry_dict[element_geometry_type_number],len(element_include_nodes_label),element_include_nodes_label-1)
                                ins_solid_result_array.InsertNextValue(ins_output_frame_result_set[0,element_label-1])
                            else:
                                continue
                        ins_surface_ugrid.GetCellData().AddArray(ins_surface_result_array)
                        ins_solid_ugrid.GetCellData().AddArray(ins_solid_result_array)

                        ins_whole_append_filter = vtk.vtkAppendFilter()
                        
                        ins_surface_other_points_cleaner = vtk.vtkCleanUnstructuredGrid()
                        ins_surface_other_points_cleaner.SetInputData(ins_surface_ugrid)
                        ins_surface_other_points_cleaner.SetTolerance(1e-6)
                        ins_surface_other_points_cleaner.RemovePointsWithoutCellsOn()
                        ins_surface_other_points_cleaner.Update()
                        ins_surface_data_to_points_transformer = vtk.vtkCellDataToPointData()
                        ins_surface_data_to_points_transformer.SetInputData(ins_surface_other_points_cleaner.GetOutput())
                        ins_surface_data_to_points_transformer.AddCellDataArray('EX')
                        ins_surface_data_to_points_transformer.SetPassCellData(0)
                        ins_surface_data_to_points_transformer.Update()
                        ins_surface_data_to_points_transformer.GetOutput().GetPointData().SetActiveScalars('EX')
                        ins_surface_domain_clipper = vtk.vtkClipDataSet()
                        ins_surface_domain_clipper.SetInputData(ins_surface_data_to_points_transformer.GetOutput())
                        ins_surface_domain_clipper.SetValue(threshold_value)
                        ins_surface_domain_clipper.SetInsideOut(reserved_type_num)
                        ins_surface_domain_clipper.Update()
                        if ins_surface_domain_clipper.GetOutput().GetNumberOfCells() == 0:
                            pass
                        else:
                            ins_surface_output_domain_cleaner = vtk.vtkCleanUnstructuredGrid()
                            ins_surface_output_domain_cleaner.SetInputData(ins_surface_domain_clipper.GetOutput())
                            ins_surface_output_domain_cleaner.SetTolerance(1e-6)
                            ins_surface_output_domain_cleaner.RemovePointsWithoutCellsOn()
                            ins_surface_output_domain_cleaner.Update()
                            
                            ins_surface_output_domain_geometry_filter = vtk.vtkGeometryFilter()
                            ins_surface_output_domain_geometry_filter.SetInputData(ins_surface_output_domain_cleaner.GetOutput())
                            ins_surface_output_domain_geometry_filter.Update()
                            ins_surface_output_domain_connectivity_filter = vtk.vtkPolyDataConnectivityFilter()
                            ins_surface_output_domain_connectivity_filter.SetInputData(ins_surface_output_domain_geometry_filter.GetOutput())
                            ins_surface_output_domain_connectivity_filter.SetExtractionModeToLargestRegion()
                            ins_surface_output_domain_connectivity_filter.Update()
                            ins_surface_output_domain_triangle_filter = vtk.vtkTriangleFilter()
                            ins_surface_output_domain_triangle_filter.SetInputData(ins_surface_output_domain_connectivity_filter.GetOutput())
                            ins_surface_output_domain_triangle_filter.SetPassVerts(0)
                            ins_surface_output_domain_triangle_filter.SetPassLines(0)
                            ins_surface_output_domain_triangle_filter.Update()
                            ins_surface_output_domain_triangle_cleaner = vtk.vtkCleanPolyData()
                            ins_surface_output_domain_triangle_cleaner.SetInputData(ins_surface_output_domain_triangle_filter.GetOutput())
                            ins_surface_output_domain_triangle_cleaner.SetTolerance(1e-4)
                            ins_surface_output_domain_triangle_cleaner.PointMergingOn()
                            ins_surface_output_domain_triangle_cleaner.ConvertStripsToPolysOn()
                            ins_surface_output_domain_triangle_cleaner.ConvertPolysToLinesOn()
                            ins_surface_output_domain_triangle_cleaner.ConvertLinesToPointsOn()
                            ins_surface_output_domain_triangle_cleaner.Update()
                            ins_surface_output_domain_extract_triangle_cells = vtk.vtkExtractCellsByType()
                            ins_surface_output_domain_extract_triangle_cells.SetInputData(ins_surface_output_domain_triangle_cleaner.GetOutput())
                            ins_surface_output_domain_extract_triangle_cells.AddCellType(5)
                            ins_surface_output_domain_extract_triangle_cells.Update()
                            ins_surface_output_domain_triangle_subdivision_filter = vtk.vtkLoopSubdivisionFilter()
                            ins_surface_output_domain_triangle_subdivision_filter.SetInputData(ins_surface_output_domain_extract_triangle_cells.GetOutput())
                            ins_surface_output_domain_triangle_subdivision_filter.SetNumberOfSubdivisions(2)
                            ins_surface_output_domain_triangle_subdivision_filter.Update()
                            ins_surface_output_domain_triangle_normals_filter = vtk.vtkPolyDataNormals()
                            ins_surface_output_domain_triangle_normals_filter.SetInputData(ins_surface_output_domain_triangle_subdivision_filter.GetOutput())
                            ins_surface_output_domain_triangle_normals_filter.AutoOrientNormalsOn()
                            ins_surface_output_domain_triangle_normals_filter.ConsistencyOn()
                            ins_surface_output_domain_triangle_normals_filter.SplittingOff()
                            ins_surface_output_domain_triangle_normals_filter.Update()
                            ins_surface_output_domain_triangle_smooth_filter = vtk.vtkWindowedSincPolyDataFilter()
                            ins_surface_output_domain_triangle_smooth_filter.SetInputData(ins_surface_output_domain_triangle_normals_filter.GetOutput())
                            ins_surface_output_domain_triangle_smooth_filter.SetNumberOfIterations(30)
                            ins_surface_output_domain_triangle_smooth_filter.SetPassBand(0.01)
                            ins_surface_output_domain_triangle_smooth_filter.SetFeatureAngle(20)
                            ins_surface_output_domain_triangle_smooth_filter.SetEdgeAngle(5)
                            ins_surface_output_domain_triangle_smooth_filter.BoundarySmoothingOn()
                            ins_surface_output_domain_triangle_smooth_filter.FeatureEdgeSmoothingOff()
                            ins_surface_output_domain_triangle_smooth_filter.NonManifoldSmoothingOn()
                            ins_surface_output_domain_triangle_smooth_filter.NormalizeCoordinatesOn()
                            ins_surface_output_domain_triangle_smooth_filter.Update()

                            if thickness_value == 0.0:
                                ins_whole_append_filter.AddInputData(ins_surface_output_domain_triangle_smooth_filter.GetOutput())
                            else:
                                ins_surface_output_domain_extrude_filter = vtk.vtkLinearExtrusionFilter()
                                ins_surface_output_domain_extrude_filter.SetInputData(ins_surface_output_domain_triangle_smooth_filter.GetOutput())
                                ins_surface_output_domain_extrude_filter.SetExtrusionTypeToNormalExtrusion()
                                if surface_location == 'bottom':
                                    ins_surface_output_domain_extrude_filter.SetScaleFactor(thickness_value)
                                else:
                                    ins_surface_output_domain_extrude_filter.SetScaleFactor(-thickness_value)
                                ins_surface_output_domain_extrude_filter.CappingOn()
                                ins_surface_output_domain_extrude_filter.Update()

                                ins_whole_append_filter.AddInputData(ins_surface_output_domain_extrude_filter.GetOutput())
                        
                        ins_solid_other_points_cleaner = vtk.vtkCleanUnstructuredGrid()
                        ins_solid_other_points_cleaner.SetInputData(ins_solid_ugrid)
                        ins_solid_other_points_cleaner.SetTolerance(1e-6)
                        ins_solid_other_points_cleaner.RemovePointsWithoutCellsOn()
                        ins_solid_other_points_cleaner.Update()
                        ins_solid_cells_data_to_points_transformer = vtk.vtkCellDataToPointData()
                        ins_solid_cells_data_to_points_transformer.SetInputData(ins_solid_other_points_cleaner.GetOutput())
                        ins_solid_cells_data_to_points_transformer.AddCellDataArray('EX')
                        ins_solid_cells_data_to_points_transformer.SetPassCellData(0)
                        ins_solid_cells_data_to_points_transformer.Update()
                        ins_solid_cells_data_to_points_transformer.GetOutput().GetPointData().SetActiveScalars('EX')
                        ins_solid_domain_contour_filter = vtk.vtkMarchingContourFilter()
                        ins_solid_domain_contour_filter.SetInputData(ins_solid_cells_data_to_points_transformer.GetOutput())
                        ins_solid_domain_contour_filter.SetValue(0, threshold_value)
                        ins_solid_domain_contour_filter.ComputeNormalsOn()
                        ins_solid_domain_contour_filter.Update()
                        if ins_solid_domain_contour_filter.GetOutput().GetNumberOfCells() == 0:
                            pass
                        else:
                            ins_solid_contour_surface_cleaner = vtk.vtkCleanPolyData()
                            ins_solid_contour_surface_cleaner.SetInputData(ins_solid_domain_contour_filter.GetOutput())
                            ins_solid_contour_surface_cleaner.SetTolerance(1e-4)
                            ins_solid_contour_surface_cleaner.PointMergingOn()
                            ins_solid_contour_surface_cleaner.ConvertStripsToPolysOn()
                            ins_solid_contour_surface_cleaner.ConvertPolysToLinesOn()
                            ins_solid_contour_surface_cleaner.ConvertLinesToPointsOn()
                            ins_solid_contour_surface_cleaner.Update()
                            ins_solid_contour_surface_triangle_filter = vtk.vtkTriangleFilter()
                            ins_solid_contour_surface_triangle_filter.SetInputData(ins_solid_contour_surface_cleaner.GetOutput())
                            ins_solid_contour_surface_triangle_filter.SetPassLines(0)
                            ins_solid_contour_surface_triangle_filter.SetPassVerts(0)
                            ins_solid_contour_surface_triangle_filter.Update()
                            ins_solid_contour_surface_triangle_cleaner = vtk.vtkCleanPolyData()
                            ins_solid_contour_surface_triangle_cleaner.SetInputData(ins_solid_contour_surface_triangle_filter.GetOutput())
                            ins_solid_contour_surface_triangle_cleaner.SetTolerance(1e-4)
                            ins_solid_contour_surface_triangle_cleaner.PointMergingOn()
                            ins_solid_contour_surface_triangle_cleaner.ConvertStripsToPolysOff()
                            ins_solid_contour_surface_triangle_cleaner.ConvertPolysToLinesOff()
                            ins_solid_contour_surface_triangle_cleaner.ConvertLinesToPointsOff()
                            ins_solid_contour_surface_triangle_cleaner.Update()

                            ins_solid_implicit_surface = vtk.vtkImplicitPolyDataDistance()
                            ins_solid_implicit_surface.SetInput(ins_solid_contour_surface_triangle_cleaner.GetOutput())
                            ins_solid_ugrid_clipper = vtk.vtkClipDataSet()
                            ins_solid_ugrid_clipper.SetInputData(ins_solid_ugrid)
                            ins_solid_ugrid_clipper.SetClipFunction(ins_solid_implicit_surface)
                            ins_solid_ugrid_clipper.SetInsideOut(~reserved_type_num)
                            ins_solid_ugrid_clipper.Update()

                            ins_solid_domain_geometry_filter = vtk.vtkGeometryFilter()
                            ins_solid_domain_geometry_filter.SetInputData(ins_solid_ugrid_clipper.GetOutput())
                            ins_solid_domain_geometry_filter.Update()
                            ins_solid_domain_connectivity_filter = vtk.vtkPolyDataConnectivityFilter()
                            ins_solid_domain_connectivity_filter.SetInputData(ins_solid_domain_geometry_filter.GetOutput())
                            ins_solid_domain_connectivity_filter.SetExtractionModeToLargestRegion()
                            ins_solid_domain_connectivity_filter.Update()
                            ins_solid_domain_triangle_filter = vtk.vtkTriangleFilter()
                            ins_solid_domain_triangle_filter.SetInputData(ins_solid_domain_connectivity_filter.GetOutput())
                            ins_solid_domain_triangle_filter.SetPassVerts(0)
                            ins_solid_domain_triangle_filter.SetPassLines(0)
                            ins_solid_domain_triangle_filter.Update()
                            ins_solid_domain_triangle_cleaner = vtk.vtkCleanPolyData()
                            ins_solid_domain_triangle_cleaner.SetInputData(ins_solid_domain_triangle_filter.GetOutput())
                            ins_solid_domain_triangle_cleaner.SetTolerance(1e-6)
                            ins_solid_domain_triangle_cleaner.PointMergingOn()
                            ins_solid_domain_triangle_cleaner.ConvertStripsToPolysOff()
                            ins_solid_domain_triangle_cleaner.ConvertPolysToLinesOff()
                            ins_solid_domain_triangle_cleaner.ConvertLinesToPointsOff()
                            ins_solid_domain_triangle_cleaner.Update()
                            ins_solid_domain_triangle_subdivision_filter = vtk.vtkLoopSubdivisionFilter()
                            ins_solid_domain_triangle_subdivision_filter.SetInputData(ins_solid_domain_triangle_cleaner.GetOutput())
                            ins_solid_domain_triangle_subdivision_filter.SetNumberOfSubdivisions(2)
                            ins_solid_domain_triangle_subdivision_filter.Update()
                            ins_solid_domain_triangle_normals_filter = vtk.vtkPolyDataNormals()
                            ins_solid_domain_triangle_normals_filter.SetInputData(ins_solid_domain_triangle_subdivision_filter.GetOutput())
                            ins_solid_domain_triangle_normals_filter.AutoOrientNormalsOn()
                            ins_solid_domain_triangle_normals_filter.ConsistencyOn()
                            ins_solid_domain_triangle_normals_filter.SplittingOff()
                            ins_solid_domain_triangle_normals_filter.Update()
                            ins_solid_domain_triangle_smooth_filter = vtk.vtkWindowedSincPolyDataFilter()
                            ins_solid_domain_triangle_smooth_filter.SetInputData(ins_solid_domain_triangle_normals_filter.GetOutput())
                            ins_solid_domain_triangle_smooth_filter.SetNumberOfIterations(25)
                            ins_solid_domain_triangle_smooth_filter.SetPassBand(0.05)
                            ins_solid_domain_triangle_smooth_filter.SetFeatureAngle(20)
                            ins_solid_domain_triangle_smooth_filter.SetEdgeAngle(10)
                            ins_solid_domain_triangle_smooth_filter.BoundarySmoothingOn()
                            ins_solid_domain_triangle_smooth_filter.FeatureEdgeSmoothingOff()
                            ins_solid_domain_triangle_smooth_filter.NonManifoldSmoothingOn()
                            ins_solid_domain_triangle_smooth_filter.NormalizeCoordinatesOn()
                            ins_solid_domain_triangle_smooth_filter.Update()

                            ins_whole_append_filter.AddInputData(ins_solid_domain_triangle_smooth_filter.GetOutput())
                        
                        ins_whole_append_filter.Update()

                        ins_whole_geometry_filter = vtk.vtkGeometryFilter()
                        ins_whole_geometry_filter.SetInputData(ins_whole_append_filter.GetOutput())
                        ins_whole_geometry_filter.Update()
                        ins_whole_domain_triangle_cleaner = vtk.vtkCleanPolyData()
                        ins_whole_domain_triangle_cleaner.SetInputData(ins_whole_geometry_filter.GetOutput())
                        ins_whole_domain_triangle_cleaner.SetTolerance(1e-6)
                        ins_whole_domain_triangle_cleaner.PointMergingOn()
                        ins_whole_domain_triangle_cleaner.ConvertStripsToPolysOff()
                        ins_whole_domain_triangle_cleaner.ConvertPolysToLinesOff()
                        ins_whole_domain_triangle_cleaner.ConvertLinesToPointsOff()
                        ins_whole_domain_triangle_cleaner.Update()
                        ins_whole_domain_triangle_normals_filter = vtk.vtkPolyDataNormals()
                        ins_whole_domain_triangle_normals_filter.SetInputData(ins_whole_domain_triangle_cleaner.GetOutput())
                        ins_whole_domain_triangle_normals_filter.AutoOrientNormalsOn()
                        ins_whole_domain_triangle_normals_filter.ConsistencyOn()
                        ins_whole_domain_triangle_normals_filter.SplittingOff()
                        ins_whole_domain_triangle_normals_filter.Update()
                        ins_whole_domain_triangle_smooth_filter = vtk.vtkWindowedSincPolyDataFilter()
                        ins_whole_domain_triangle_smooth_filter.SetInputData(ins_whole_domain_triangle_normals_filter.GetOutput())
                        ins_whole_domain_triangle_smooth_filter.SetNumberOfIterations(25)
                        ins_whole_domain_triangle_smooth_filter.SetPassBand(0.05)
                        ins_whole_domain_triangle_smooth_filter.SetFeatureAngle(20)
                        ins_whole_domain_triangle_smooth_filter.SetEdgeAngle(10)
                        ins_whole_domain_triangle_smooth_filter.BoundarySmoothingOn()
                        ins_whole_domain_triangle_smooth_filter.FeatureEdgeSmoothingOff()
                        ins_whole_domain_triangle_smooth_filter.NonManifoldSmoothingOn()
                        ins_whole_domain_triangle_smooth_filter.NormalizeCoordinatesOn()
                        ins_whole_domain_triangle_smooth_filter.Update()

                        ins_stl_writer = vtk.vtkSTLWriter()
                        ins_stl_writer.SetFileName(file_basename + '-' + instance_name + '.stl')
                        ins_stl_writer.SetInputData(ins_whole_domain_triangle_smooth_filter.GetOutput())
                        ins_stl_writer.SetFileTypeToBinary()
                        ins_stl_writer.Write()
                    else:
                        ins_surface_ugrid = vtk.vtkUnstructuredGrid()
                        ...
                        for element_label in range(instance_elements_label_range[0],instance_elements_label_range[1]+1):
                            ...
                            if ins_output_frame_result_set[0,element_label-1] >= threshold_value:
                                ...
                                continue
                        if ins_surface_ugrid.GetNumberOfCells() == 0 and ins_solid_ugrid.GetNumberOfCells() == 0:
                            print('Export Failed: The threshold value is too large!')
                            raise ValueError()
                        else:
                            pass
                        ...
                        ins_surface_other_points_cleaner.Update()
                        ins_surface_output_domain_geometry_filter = vtk.vtkGeometryFilter()
                        ins_surface_output_domain_geometry_filter.SetInputData(ins_surface_other_points_cleaner.GetOutput())
                        ins_surface_output_domain_geometry_filter.Update()
                        ins_surface_output_domain_connectivity_filter = vtk.vtkPolyDataConnectivityFilter()
                        ins_surface_output_domain_connectivity_filter.SetInputData(ins_surface_output_domain_geometry_filter.GetOutput())
                        ins_surface_output_domain_connectivity_filter.SetExtractionModeToLargestRegion()
                        ...
                        ins_solid_other_points_cleaner.RemovePointsWithoutCellsOn()
                        ins_solid_other_points_cleaner.Update()
                        ins_solid_output_domain_geometry_filter = vtk.vtkGeometryFilter()
                        ins_solid_output_domain_geometry_filter.SetInputData(ins_solid_other_points_cleaner.GetOutput())
                        ins_solid_output_domain_geometry_filter.Update()
                        ins_solid_output_domain_connectivity_filter = vtk.vtkPolyDataConnectivityFilter()
                        ins_solid_output_domain_connectivity_filter.SetInputData(ins_solid_output_domain_geometry_filter.GetOutput())
                        ins_solid_output_domain_connectivity_filter.SetExtractionModeToLargestRegion()
                        ins_solid_output_domain_connectivity_filter.Update()
    
                        ins_whole_append_filter = vtk.vtkAppendFilter()
                        if thickness_value == 0.0:
                            ins_whole_append_filter.AddInputData(ins_surface_output_domain_connectivity_filter.GetOutput())
                        else:
                            ins_surface_output_domain_normals_filter = vtk.vtkPolyDataNormals()
                            ins_surface_output_domain_normals_filter.SetInputData(ins_surface_output_domain_connectivity_filter.GetOutput())
                            ins_surface_output_domain_normals_filter.AutoOrientNormalsOn()
                            ins_surface_output_domain_normals_filter.ConsistencyOn()
                            ins_surface_output_domain_normals_filter.SplittingOff()
                            ins_surface_output_domain_normals_filter.Update()
    
                            ins_surface_output_domain_extrude_filter = vtk.vtkLinearExtrusionFilter()
                            ins_surface_output_domain_extrude_filter.SetInputData(ins_surface_output_domain_normals_filter.GetOutput())
                            ins_surface_output_domain_extrude_filter.SetExtrusionTypeToNormalExtrusion()
                            if surface_location == 'bottom':
                                ins_surface_output_domain_extrude_filter.SetScaleFactor(thickness_value)
                            else:
                            ...
                            ins_whole_append_filter.AddInputData(ins_surface_output_domain_extrude_filter.GetOutput())
                        ins_whole_append_filter.AddInputData(ins_solid_output_domain_connectivity_filter.GetOutput())
                        ins_whole_append_filter.Update()
    
                        ins_whole_other_points_cleaner = vtk.vtkStaticCleanUnstructuredGrid()
                        ins_whole_other_points_cleaner.SetInputConnection(ins_whole_append_filter.GetOutputPort())
                        ins_whole_other_points_cleaner.SetTolerance(1e-8)
                        ins_whole_other_points_cleaner.ToleranceIsAbsoluteOn()
                        ins_whole_other_points_cleaner.Update()
    
                        ins_whole_output_domain_geometry_filter = vtk.vtkGeometryFilter()
                        ins_whole_output_domain_geometry_filter.SetInputData(ins_whole_other_points_cleaner.GetOutput())
                        ins_whole_output_domain_geometry_filter.Update()
    
                        ins_whole_output_domain_connectivity_filter = vtk.vtkPolyDataConnectivityFilter()
                        ins_whole_output_domain_connectivity_filter.SetInputData(ins_whole_output_domain_geometry_filter.GetOutput())
                        ins_whole_output_domain_connectivity_filter.SetExtractionModeToLargestRegion()
                        ins_whole_output_domain_connectivity_filter.Update()
                        
                        ins_stl_writer = vtk.vtkSTLWriter()
                        ins_stl_writer.SetFileName(file_basename + '-' + instance_name + '.stl')
                        ins_stl_writer.SetInputData(ins_whole_output_domain_connectivity_filter.GetOutput())
                        ins_stl_writer.SetFileTypeToBinary()
                        ins_stl_writer.Write()
                else:
                    pass
