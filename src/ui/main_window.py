...
def qtMessageHandler(in_type: int, in_ins_object: object, in_content: str) -> None:
    if in_ins_object.category == 'qt.qpa.screen' and 'Unable to open monitor interface' in in_content:
        return
    else:
        message_type = {
        ...
        print('GUI' + message_type + ':' + in_content)
