...
def getAvailableProcessNumber() -> int:
    ...
    if available_cpu_number <= 0:
        ...
        pass
    return available_cpu_number

# region
def __pardiso_direct_lsolver(in_coefficient_matrix:scipy.sparse.csr_matrix,in_right_array:numpy.ndarray) -> numpy.ndarray:
    ins_pardiso_lsolver = pypardiso.PyPardisoSolver()
    ins_pardiso_lsolver.set_matrix_type(2)
    ins_pardiso_lsolver.set_iparm(1,1)
    ins_pardiso_lsolver.set_iparm(2,3)
    ins_pardiso_lsolver.set_iparm(4,0)
    ins_pardiso_lsolver.set_iparm(5,0)
    ins_pardiso_lsolver.set_iparm(6,0)
    ins_pardiso_lsolver.set_iparm(8,2)
    ins_pardiso_lsolver.set_iparm(10,13)
    ins_pardiso_lsolver.set_iparm(11,0)
    ins_pardiso_lsolver.set_iparm(12,0)
    ins_pardiso_lsolver.set_iparm(13,0)
    ins_pardiso_lsolver.set_iparm(18,0)
    ins_pardiso_lsolver.set_iparm(19,0)
    ins_pardiso_lsolver.set_iparm(21,0)
    ins_pardiso_lsolver.set_iparm(24,1)
    ins_pardiso_lsolver.set_iparm(25,1)
    ins_pardiso_lsolver.set_iparm(27,0)
    ins_pardiso_lsolver.set_iparm(28,0)
    ins_pardiso_lsolver.set_iparm(31,0)
    ins_pardiso_lsolver.set_iparm(34,0)
    ins_pardiso_lsolver.set_iparm(35,0)
    ins_pardiso_lsolver.set_iparm(36,0)
    ins_pardiso_lsolver.set_iparm(37,0)
    ins_pardiso_lsolver.set_iparm(56,0)
    ins_pardiso_lsolver.set_iparm(60,0)
    unknown_array = ins_pardiso_lsolver.solve(scipy.sparse.triu(in_coefficient_matrix.astype(numpy.dtype('float64')),format='csr'),in_right_array.astype(numpy.dtype('float64')))
    ins_pardiso_lsolver.free_memory(everything=True)
    del ins_pardiso_lsolver
...
def __scipy_gcrotmk_iterative_solver(in_coefficient_matrix:scipy.sparse.csr_matrix,in_right_array:numpy.ndarray) -> numpy.ndarray:
    ...
    return unknown_array
def __scipy_qmr_iterative_solver(in_coefficient_matrix:scipy.sparse.csr_matrix,in_right_array:numpy.ndarray) -> numpy.ndarray:
    unknown_array, exit_code = scipy.sparse.linalg.qmr(in_coefficient_matrix,in_right_array)
...
lsolver_dict = {
                ...
                2:{1:__scipy_cg_iterative_solver,2:__scipy_bicgstab_iterative_solver,
                   ...
                   5:__scipy_qmr_iterative_solver,6:__scipy_lsmr_iterative_solver}
                }
...
def __mma__osolver(m:int, n:int, iter:int, 
    ...
    epsimin = 0.0000001
    eeen = numpy.ones((n, 1), dtype=common.P4SFormat.NUMERICAL_PRECISION['float'])
    eeem = numpy.ones((m, 1), dtype=common.P4SFormat.NUMERICAL_PRECISION['float'])
    zeron = numpy.zeros((n, 1), dtype=common.P4SFormat.NUMERICAL_PRECISION['float'])
    ...
    p0 = p0 * ux2
    q0 = q0 * xl2
    P = numpy.zeros((m, n), dtype=common.P4SFormat.NUMERICAL_PRECISION['float'])
    Q = numpy.zeros((m, n), dtype=common.P4SFormat.NUMERICAL_PRECISION['float'])
